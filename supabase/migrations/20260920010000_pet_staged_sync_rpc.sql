-- Extend the atomic staged-sync boundary with pet-domain LWW operations.

drop function public.apply_staged_sync(
...
alter function private.apply_staged_sync(
    jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,
    jsonb,timestamptz,jsonb,timestamptz,boolean,jsonb,timestamptz,boolean
) rename to apply_staged_sync_without_pets;

revoke all on function private.apply_staged_sync_without_pets(
    jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,
    jsonb,timestamptz,jsonb,timestamptz,boolean,jsonb,timestamptz,boolean
) from public, anon, authenticated, service_role;

create function private.apply_staged_sync(
...
begin
  ...
  for v_row in select * from jsonb_array_elements(coalesce(p_pet_activity_upserts,'[]')) loop insert into public.pet_activity_records(owner_id,id,activity_type,occurred_at,duration_minutes,created_at,updated_at) values(v_owner,(v_row->>'id')::uuid,v_row->>'activity_type',(v_row->>'occurred_at')::timestamptz,(v_row->>'duration_minutes')::double precision,(v_row->>'created_at')::timestamptz,(v_row->>'updated_at')::timestamptz) on conflict (owner_id,id) do update set activity_type=excluded.activity_type,occurred_at=excluded.occurred_at,duration_minutes=excluded.duration_minutes,created_at=excluded.created_at,updated_at=excluded.updated_at where excluded.updated_at > public.pet_activity_records.updated_at; end loop;
...
create function public.apply_staged_sync(
    p_task_upserts jsonb,p_task_tombstones jsonb,p_log_upserts jsonb,p_log_tombstones jsonb,p_habit_upserts jsonb,p_habit_tombstones jsonb,p_habit_completion_upserts jsonb,p_habit_completion_tombstones jsonb,p_todo_upserts jsonb,p_todo_tombstones jsonb,p_todo_completion_upserts jsonb,p_todo_completion_tombstones jsonb,
    p_pet_activity_upserts jsonb,p_pet_activity_tombstones jsonb,p_pet_profile_upsert jsonb,p_pet_profile_tombstone jsonb,p_pet_schedule_upserts jsonb,p_pet_schedule_tombstones jsonb,p_pet_nap_upserts jsonb,p_pet_nap_tombstones jsonb,p_pet_weight_upserts jsonb,p_pet_weight_tombstones jsonb,p_pet_training_skill_upserts jsonb,p_pet_training_skill_tombstones jsonb,p_pet_fixation_upserts jsonb,p_pet_fixation_tombstones jsonb,p_pet_notable_event_upserts jsonb,p_pet_notable_event_tombstones jsonb,
    p_settings_data jsonb,p_settings_updated_at timestamptz,p_timer_data jsonb,p_timer_updated_at timestamptz,p_timer_new_generation boolean,p_pm_data jsonb,p_pm_updated_at timestamptz,p_full_wipe boolean
) returns void language sql security invoker set search_path='' as $$ select private.apply_staged_sync(p_task_upserts,p_task_tombstones,p_log_upserts,p_log_tombstones,p_habit_upserts,p_habit_tombstones,p_habit_completion_upserts,p_habit_completion_tombstones,p_todo_upserts,p_todo_tombstones,p_todo_completion_upserts,p_todo_completion_tombstones,p_pet_activity_upserts,p_pet_activity_tombstones,p_pet_profile_upsert,p_pet_profile_tombstone,p_pet_schedule_upserts,p_pet_schedule_tombstones,p_pet_nap_upserts,p_pet_nap_tombstones,p_pet_weight_upserts,p_pet_weight_tombstones,p_pet_training_skill_upserts,p_pet_training_skill_tombstones,p_pet_fixation_upserts,p_pet_fixation_tombstones,p_pet_notable_event_upserts,p_pet_notable_event_tombstones,p_settings_data,p_settings_updated_at,p_timer_data,p_timer_updated_at,p_timer_new_generation,p_pm_data,p_pm_updated_at,p_full_wipe) $$;

revoke all on function private.apply_staged_sync(jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,timestamptz,jsonb,timestamptz,boolean,jsonb,timestamptz,boolean) from public,anon;
grant execute on function private.apply_staged_sync(jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,timestamptz,jsonb,timestamptz,boolean,jsonb,timestamptz,boolean) to authenticated,service_role;
revoke all on function public.apply_staged_sync(jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb,timestamptz,jsonb,timestamptz,boolean,jsonb,timestamptz,boolean) from public,anon;
