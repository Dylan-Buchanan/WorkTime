...
describe("security-definer RPC privileges", () => {
    it("denies anonymous staged sync calls", async () => {
        ...
        await expectPermissionDenied(client.rpc("apply_staged_sync", {
            ...
            p_pet_activity_upserts: null,
            p_pet_activity_tombstones: null,
            p_pet_profile_upsert: null,
            p_pet_profile_tombstone: null,
            p_pet_schedule_upserts: null,
            p_pet_schedule_tombstones: null,
            p_pet_nap_upserts: null,
            p_pet_nap_tombstones: null,
            p_pet_weight_upserts: null,
            p_pet_weight_tombstones: null,
            p_pet_training_skill_upserts: null,
            p_pet_training_skill_tombstones: null,
            p_pet_fixation_upserts: null,
            p_pet_fixation_tombstones: null,
            p_pet_notable_event_upserts: null,
            p_pet_notable_event_tombstones: null,
